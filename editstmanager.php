...
if($_POST)
{
    ...
    if($query)
    {
        echo "<script>alert('record updated'); window.location='storemanager.php';</script>";
    }        
}
    ...
    <body>
        ...
        <section class="home">
            ...
            <div class="main">
                ...
                &nbsp;&nbsp;&nbsp;<button><a href="storemanager.php" style="font-size: 20px">
                        Back &raquo;</a></button>
                <br><br>
                &nbsp;&nbsp;&nbsp;<h2 class="title1"> EDIT STORE-MANAGER</h2>
                <div class="container">
                    <form method = "post">
                        <p>
                            &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;
